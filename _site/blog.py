...
def get_coords(ip):
    ...
    if content:
        ...
        coodrs = d.getElementsByTagName("gml:coordinates")
        if coodrs and coodrs[0].childNodes[0].nodeValue:
            lon , lat = coodrs[0].childNodes[0].nodeValue.split(',')
            return db.GeoPt( lat ,lon)

def gmap_img(points):
    url ='http://maps.googleapis.com/maps/api/staticmap?&size=600x300&sensor=false&'
